...
export default function SponsoredPage() {
  const filteredNews = [...mockNews].slice(15, 60).map(n => ({...n, category: "Sponsored"}));
      ...
      <div className="flex flex-col gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-border-strong pb-6">
          <div>
            ...
            <p className="text-text-muted text-lg max-w-2xl">Promotions, announcements, and featured content from our trusted partners.</p>
          </div>
