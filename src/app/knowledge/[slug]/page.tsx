      ...
      <div className="flex flex-col gap-8 max-w-4xl mx-auto mt-6">
        ...
        <div className="mt-16 pt-12 border-t border-border-strong">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/knowledge" className="text-sm font-semibold text-[#8AA0E5] hover:text-foreground transition-colors">More Knowledge &raquo;</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockNews.slice(6, 9).map((news, idx) => (
              <NewsCard key={idx} {...news} category="Knowledge" />
            ))}
          </div>
        </div>
