    ...
    <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar pb-20">
      <div className="flex flex-col gap-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-border-strong pb-6">
          <div>
            <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-2">Latest News</h1>
            <p className="text-text-muted max-w-2xl">Stay updated with the latest breaking news, market analysis, and in-depth articles from the cryptocurrency and blockchain world.</p>
          </div>
